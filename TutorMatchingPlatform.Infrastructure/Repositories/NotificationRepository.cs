...
namespace TutorMatchingPlatform.Infrastructure.Repositories
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        private Notification MapToDomain(NotificationDataModel dataModel)
        {
            ...
            var idProperty = typeof(TutorMatchingPlatform.Domain.Common.BaseEntity).GetProperty("Id");
            if (idProperty != null && idProperty.CanWrite)
            {
                idProperty.SetValue(notification, dataModel.Id);
            }
            
            var createdProperty = typeof(TutorMatchingPlatform.Domain.Common.BaseEntity).GetProperty("CreatedAt");
