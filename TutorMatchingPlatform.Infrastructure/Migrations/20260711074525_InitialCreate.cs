        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LearningGoals_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LearningGoals_Users_TutorId",
                        column: x => x.TutorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LearningPreferences = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HourlyCredits = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditTransactions_Bookings_BookingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorNotes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GoalProgress_LearningGoals_LearningGoalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ScheduledStartAt",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditTransactions_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoalProgress_LearningGoalId",
                table: "GoalProgress",
                column: "LearningGoalId");

            migrationBuilder.CreateIndex(
                name: "IX_GoalProgress_RecordedAt",
                table: "GoalProgress",
                column: "RecordedAt");

            migrationBuilder.CreateIndex(
                name: "IX_LearningGoals_Status",
                table: "LearningGoals",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_LearningGoals_StudentId_SubjectId",
                table: "LearningGoals",
                columns: new[] { "StudentId", "SubjectId" });

            migrationBuilder.CreateIndex(
                name: "IX_LearningGoals_SubjectId",
                table: "LearningGoals",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_LearningGoals_TutorId_StudentId",
                table: "LearningGoals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_BookingId_ReviewType",
                table: "Reviews",
                columns: new[] { "BookingId", "ReviewType" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TutorProfiles_IsApproved",
                table: "TutorProfiles",
                column: "IsApproved");
