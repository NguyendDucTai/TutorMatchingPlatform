...
using TutorMatchingPlatform.Application.Features.Subjects.Commands.CreateSubject;
using TutorMatchingPlatform.Application.Features.Subjects.Queries.GetAllSubjects;
...
namespace TutorMatchingPlatform.API.Controllers
{
    ...
    public class SubjectsController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateSubject(Guid id, [FromBody] TutorMatchingPlatform.Application.Features.Subjects.Commands.UpdateSubject.UpdateSubjectCommand command)
        {
            if (id != command.Id)
            {
        ...
        {
            var command = new TutorMatchingPlatform.Application.Features.Subjects.Commands.DeleteSubject.DeleteSubjectCommand(id);
            var response = await _mediator.Send(command);
        ...
        {
            var command = new TutorMatchingPlatform.Application.Features.Subjects.Commands.ReactivateSubject.ReactivateSubjectCommand(id);
            var response = await _mediator.Send(command);
            return Ok(ApiResponse<SubjectDto>.Ok(response));
        }
    }
